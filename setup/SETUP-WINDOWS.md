...
```
C:\Users\YourName\Documents\alice\
```
...
3. Action: Start a program
   - Program: `python`
   - Arguments: `auto-scripts\script_name.py`
...
## Step 8 — Schedule Automations via Windows Task Scheduler (Mode 3)

> The FastAPI server is not required for scheduling. Use Windows Task Scheduler to run scripts persistently without a server.

### Windows Task Scheduler

1. Press `Win + S` → search **Task Scheduler** → open it
2. Click **Create Basic Task**
3. Name it (e.g. "Alice – Daily Report")
4. Set your trigger
5. Action: **Start a program**
   - Program: `python`
   - Arguments: `auto-scripts\script_name.py`
   - Start in: `C:\Users\YourName\Documents\alice`
6. Click Finish
